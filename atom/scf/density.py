...
class DensityCalculator:
    ...
    def compute_density_laplacian(self, rho: np.ndarray) -> np.ndarray:
        ...
        # Compute gradient and Laplacian, nabla^2 ρ = d^2ρ/dr^2 + 2/r dρ/dr
        grad_rho_reshaped = np.matmul(self.derivative_matrix, rho_reshaped)
        r_square_times_grad_rho_reshaped = quadrature_nodes_reshaped**2 * grad_rho_reshaped
        laplacian_rho_reshaped = np.matmul(self.derivative_matrix, r_square_times_grad_rho_reshaped) / quadrature_nodes_reshaped**2
