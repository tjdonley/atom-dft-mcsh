...
def lda_exchange_generic(rho: DensityData) -> GenericXCResult:
    """
    Compute LDA exchange in generic form.
...
def lda_correlation_generic(rho: np.ndarray) -> np.ndarray:
    """
    Compute LDA correlation in generic form.
