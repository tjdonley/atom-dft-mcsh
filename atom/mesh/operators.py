...
NUMBER_OF_FINITE_ELEMENTS_NOT_USED_WHEN_USING_GRID_DATA_WARNING = \
    "WARNING: parameter 'number_of_finite_elements' is not used when using GridData"
FINITE_ELEMENT_NUMBER_NOT_USED_WHEN_USING_GRID_DATA_WARNING = \
    "WARNING: parameter 'finite_element_number' is not used when using GridData"
PHYSICAL_NODES_NOT_USED_WHEN_USING_GRID_DATA_WARNING = \
    "WARNING: parameter 'physical_nodes' is not used when using GridData"
QUADRATURE_NODES_NOT_USED_WHEN_USING_GRID_DATA_WARNING = \
    "WARNING: parameter 'quadrature_nodes' is not used when using GridData"
QUADRATURE_WEIGHTS_NOT_USED_WHEN_USING_GRID_DATA_WARNING = \
    "WARNING: parameter 'quadrature_weights' is not used when using GridData"
...
class RadialOperatorsBuilder:
    ...
    def __init__(self, 
        ...
        Mode 1 - From individual parameters:
            finite_element_number, physical_nodes, quadrature_nodes, quadrature_weights
        ...
        finite_element_number : int, optional
            Number of finite elements
        ...
        if grid_data is not None:
            ...
            self.finite_element_number = grid_data.finite_element_number
            ...
            assert finite_element_number is not None, \
                "finite_element_number required"
    ...
    def from_grid_data(cls, grid_data: GridData, verbose: bool = False, builder_label: str = "") -> 'RadialOperatorsBuilder':
        ...
        """
        return cls(grid_data=grid_data, verbose=verbose, builder_label=builder_label)
